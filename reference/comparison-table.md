...
| **Fuel speed** | Fast, explosive | Slow, background | Slow, emergency backup |
| **Main role** | Fast fuel | Slow fuel + hormones | Building + repair |
...
| **Stored directly** | Through glycogenesis | Through esterification | No |
| **Becomes fat** | Yes, surplus | If insulin is high | Theoretically yes, practically no |
...
| **Requires insulin** | Not necessarily | Requires LOW insulin | -- |
...
| Legumes | Moderate-low |
| Meat, fish, eggs | Low, plus glucagon |
| Pure fats | ~  Minimal |
| Green vegetables | ~  Minimal |
...
| **Calories** | Small deficit, -200-300 kcal | Slow fat loss that still allows building |
...
| Nuts, almonds | ~  Minimal | Yes |
| Boiled eggs | Low | Yes |
| Cheese, plain Greek yogurt | Moderate | Yes |
| Protein shake, no sugar | Low | Yes |
| **No snack** | 0, burning window | Ideal |
