...
> Vocabularul esențial și logica proceselor metabolice: fundația pentru tot ce urmează.
...
| **Glicemie** | *Nivelul* glucozei în sânge; o măsurătoare, nu o substanță separată |
...
- **`-geneză`** = *producere* a ceva: construire sau stocare
- **`-liză`** = *descompunere* a ceva: eliberare sau ardere
...
> Cele două reguli de tip **NU** explică multe:
>
